...
| --- | --- |
| [zealish-router](https://github.com/zealish/zealish-router) | A self-hostable Go AI gateway with OpenAI/Anthropic-compatible APIs, multi-provider routing, fallback chains, streaming, caching, metrics, and a Next.js dashboard. |
| [zchat](https://github.com/zealish/zchat) | A native GTK4/Libadwaita WhatsApp Multi-Device client with a Go daemon, WhatsMeow, SQLite persistence, and local gRPC IPC. |
| [whatsapp-go](https://github.com/zealish/whatsapp-go) | A Linux desktop WhatsApp Web client built with Go, GTK4, WebKitGTK, JavaScript-to-Go integration, notifications, and system-tray support. |
| [muslimpack](https://github.com/zealish/muslimpack) | A Kotlin/Compose Android companion for Muslim daily life with local persistence, location-aware features, API synchronization, and scheduled prayer reminders. |
| [KemanaAja](https://github.com/zealish/KemanaAja) | An offline-first Kotlin/Compose personal-finance app with Room, transactions, budgets, savings goals, history, recaps, and statistics. |
...
- Improving observability, persistence, and developer experience

## Let's connect

Explore my [repositories](https://github.com/zealish?tab=repositories) or open an issue if you would like to collaborate.
